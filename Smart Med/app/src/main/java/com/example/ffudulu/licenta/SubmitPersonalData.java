...
public class SubmitPersonalData extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    for (DataSnapshot dss : ds.getChildren()){
                        if(dss.child(firebaseUser.getUid()).getValue()!=null) {
                            ...
                            mFirstName.setText(userMedic.getFirstName());
                            mLastName.setText(userMedic.getLastName());
                            mHospitalName.setText(userMedic.getHospitalName());
                            mSectionName.setText(userMedic.getSectionName());
                        }
                    }
        ...
        if (firebaseUser.getPhotoUrl() != null){
            Picasso.with(SubmitPersonalData.this).load(firebaseUser.getPhotoUrl())
